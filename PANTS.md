...
- [ ] **Retrieve the HGMP01 sequence by hand from PMID 39551294's supplementary**, and compare it directly against whatever the gut recall returned. Until then the gut candidates are unvalidated against the one enzyme known to be there
